...
public class Assets implements Disposable {
    ...
    private final AssetDescriptor<Texture> titleTextureAsset = new AssetDescriptor<>("images/title-2.png", Texture.class);
    ...
    public Assets(Loading loading) {
        ...
        mgr.load("audio/pickup_flesh.wav", Sound.class);
    ...
    public float updateLoading() {
        ...
        playerEnterMech = new Animation<>(0.1f, atlas.findRegions("zombie-enter"), Animation.PlayMode.NORMAL);
        playerLeaveMech = new Animation<>(0.1f, atlas.findRegions("zombie-enter"), Animation.PlayMode.REVERSED);
        ...
        pickup_flesh = mgr.get("audio/pickup_flesh.wav", Sound.class);
